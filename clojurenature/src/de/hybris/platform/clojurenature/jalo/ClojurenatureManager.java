 ...
 */
package de.hybris.platform.clojurenature.jalo;
...
import de.hybris.platform.clojurenature.constants.ClojurenatureConstants;



/**
 * This is the extension manager of the Clojurenature extension.
 */
public class ClojurenatureManager extends GeneratedClojurenatureManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ClojurenatureManager.class);
	 ...
	 */
	public static ClojurenatureManager getInstance()
	{
		return (ClojurenatureManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ClojurenatureConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ClojurenatureManager() // NOPMD 
	{
		LOG.debug("constructor of ClojurenatureManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ClojurenatureManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ClojurenatureManager called, current tenant: {}", getTenant().getTenantID());
	}
