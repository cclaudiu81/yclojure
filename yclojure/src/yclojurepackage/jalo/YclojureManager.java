...
/**
 * This is the extension manager of the Yclojure extension.
 */
public class YclojureManager extends GeneratedYclojureManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(YclojureManager.class);
	 ...
	 */
	public static YclojureManager getInstance()
	{
		return (YclojureManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YclojureConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YclojureManager() // NOPMD 
	{
		LOG.debug("constructor of YclojureManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of YclojureManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of YclojureManager called, current tenant: {}", getTenant().getTenantID());
	}
